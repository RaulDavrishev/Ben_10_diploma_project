...
public class Area_8 : MonoBehaviour{
    ...
    public GameObject Upgrade_Level_Position;
        ...
        yield return new WaitForSeconds(1.0f);
            ...
            for(int i=0; i<=10; i++){
                if(Character_models[i].activeSelf){
                    ...
                    Character_models[i].transform.position = Upgrade_Level_Position.transform.position;
