...
public class Control_Diamondhead : MonoBehaviour{
    ...
    void aimAndThrow(){
        ...
        if(Input.GetMouseButtonDown(0) && crosshair.activeSelf){ anim.SetBool ("throw", true); StartCoroutine(ShootDelay()); }
    ...
    IEnumerator ShootDelay(){
        ...
        sounds.PlayOneShot(ShootSound, 0.05f);
    }
